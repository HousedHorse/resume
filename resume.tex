...
\lhead{}
\chead{}
\rhead{\color{gray}Last Updated: \today}
\lfoot{}
\cfoot{}
\rfoot{}
...
\newgeometry{left=0.6in,top=.8in,bottom=.8in,right=0.6in}
...
%  {\bfseries \large APIs and Libraries} &&\\
%  \bfseries
%  C++           &--& Qt\\
%  \bfseries
%  Javascript    &--& Node.js, Jquery\vspace{0.5em}\\
%  {\bfseries \large Workflow} &&\\
%  \bfseries
